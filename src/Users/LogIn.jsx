        ...
        <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12  mt-24">
          <div className=" flex flex-col items-center">
            <div className="text-center">
              <h1 className="text-2xl xl:text-4xl font-extrabold text-[#043BD4] font-Briem">
                Log-In
            ...
            <div className="w-full flex-1 mt-8">
              <div className="mx-auto max-w-xs flex flex-col gap-4">
                ...
                <button className="mt-5 tracking-wide font-semibold bg-[#043BD4] text-gray-100 w-full py-4 rounded-lg hover:bg-slate-400 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                  <svg
